...
(echo $password; echo $password)| sudo smbpasswd -s $USERNAME
echo "creating nextcloud user..."
sudo /usr/bin/docker exec -e "OC_PASS=$password" -u 33 $DOCKER_ID ./occ user:resetpassword --password-from-env $USERNAME
